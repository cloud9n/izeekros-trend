...
export const HSE: React.FC = () => {
  return (
    <section id="hse" className="py-24 bg-brand-800 relative overflow-hidden">
      {/* Background graphic */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <Reveal direction="left">
            <h2 className="text-3xl md:text-5xl font-display font-bold text-brand-light mb-6">
              Quality & <span className="text-brand-accent">HSE</span>
            </h2>
            <div className="text-2xl font-bold text-gray-700 mb-8 border-l-4 border-brand-accent pl-6">
              "Think Safety First."
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              <div className="flex items-center gap-3 bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
                ...
                <div>
                  <div className="font-bold text-brand-light">CAC Registered</div>
                  <div className="text-xs text-gray-500">Corporate Affairs Commission</div>
                </div>
              </div>
              <div className="flex items-center gap-3 bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
                <FileText className="w-8 h-8 text-brand-blue" />
                <div>
                  <div className="font-bold text-brand-light">FIRS Certified</div>
                  <div className="text-xs text-gray-500">Federal Inland Revenue</div>
                </div>
              </div>
            </div>
          </Reveal>
          ...
          <Reveal direction="right" className="relative">
            <div className="aspect-square max-w-md mx-auto relative">
              ...
              <div className="absolute inset-4 bg-white rounded-full border border-gray-100 flex items-center justify-center shadow-2xl">
                <div className="text-center p-8">
                  <ShieldAlert className="w-24 h-24 text-brand-accent mx-auto mb-6" />
                  <h3 className="text-2xl font-bold text-brand-light mb-2">Zero Tolerance</h3>
                  <p className="text-gray-500 text-sm">For safety violations across all operational sites.</p>
                </div>
              </div>
            </div>
          </Reveal>
